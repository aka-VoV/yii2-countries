...
-- Dumping structure for table pigmilk.country
...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  `name_ru` tinytext NOT NULL,
  `name_uk` tinytext NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `alpha` (`alpha`)
) ENGINE=InnoDB AUTO_INCREMENT=250 DEFAULT CHARSET=utf8;

-- Dumping data for table pigmilk.country: ~249 rows (approximately)
/*!40000 ALTER TABLE `country` DISABLE KEYS */;
INSERT IGNORE INTO `country` (`id`, `number`, `alpha`, `calling`, `name_en`, `name_ru`, `name_uk`) VALUES
	...
	(196, 678, 'st', 239, 'São Tomé and Príncipe', '', ''),
